...
AfterMD is a **GROMACS MD Analysis Toolkit** designed for large-scale batch processing and HPC cluster deployment. The architecture follows a **modular, layered design** with clear separation between utilities, preprocessing, analysis, and quality control.
...
```python
from aftermd.analysis.quality import MDCompletenessChecker
...
```python
from aftermd.analysis.quality import StructureValidator
...
**RadiusGyrationCalculator**:
```python
from aftermd.analysis import RadiusGyrationCalculator
...
**BFactorAnalyzer**:
```python
from aftermd.analysis import BFactorAnalyzer
...
```python
from aftermd.utils import PlotManager
...
# Output:
# slurm_scripts/aftermd_batch_1.sh
# slurm_scripts/aftermd_batch_2.sh
...
```python
# aftermd/analysis/quality/trajectory_stability.py
...
from aftermd.analysis.trajectory import BaseTrajectoryAnalyzer
