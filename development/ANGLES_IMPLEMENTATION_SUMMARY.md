...
## Integration with AfterMD

**Module Location:** `aftermd.analysis.angles`
...
- CLI commands (future: `aftermd-calc-angles`)
...
- [ ] CLI command: `aftermd-calc-angles`
...
Successfully implemented a complete, tested, and documented TCR-pMHC docking angle analysis module. The implementation follows modern Python best practices, integrates seamlessly with AfterMD's architecture, and provides robust quantification of binding conformations in MD trajectories.
